  ...
  return (
    <div className="bg-gradient-to-r from-purple-100 to-purple-200 text-gray-800 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        ...
        <p className="text-lg mb-8">Welcome to <strong className="text-purple-700">FashionShop</strong>, where your style meets technology. We specialize in curating personalized outfits that reflect your unique personality through the magic of pop culture and advanced algorithms.</p>
        ...
        <p className="text-lg mb-8">Join us at FashionShop and redefine your wardrobe with personalized, trendy outfits.</p>

        <p className="text-purple-700 text-xl font-semibold">FashionShop - Your Style, Perfected</p>
      </div>
    </div>
  );
};
